...
#fyr=2018
#
#arrx=$(fcal $fmonth $fyr)
#fm3=$(fcal_fmmm $fmonth)
#icm=$(fcal_icm $fmonth)
#icy=$(fcal_icy $fmonth $fyr)
#icmmm=$(fcal_icmmm $fmonth)
#arr_mmmd=$(fcal_icmmmd $fmonth $fyr)
...
#output: 
#12:12 12:17 12:22 12:27
#jan
#12 2017
#dec
#dec12 dec17 dec22 dec27


#a=()
#a=$(nextXmonths_seasonalStrMMM 2018 4 9 )
#for x in ${a[@]}; do 
#    echo $x
#done

#a=$(nextXmonths_mmmyyyy 2018 3 0 9)
#
#for x in ${a[@]}; do
#    IFS=":" read -ra var <<<"$x"
#    foo=${var[0]#0}   #<== month
...
#input
#a=$(nextXmonths_mmmyyyy 2018 3 0 9 u)
#output
#Mar:2018 Apr:2018 May:2018 Jun:2018 Jul:2018 Aug:2018 Sep:2018 Oct:2018 Nov:2018

#input
#a=$(nextXmonths_mmmyyyy 2018 3 0 9 l )
#output
#mar:2018 apr:2018 may:2018 jun:2018 jul:2018 aug:2018 sep:2018 oct:2018 nov:2018

#input
#a=$(nextXmonths_mmmyyyy 2018 1 -1 9 l)
#output
#dec:2017 jan:2018 feb:2018 mar:2018 apr:2018 may:2018 jun:2018 jul:2018 aug:2018

#x=$(numdaysinmonth 2 2016)
#echo $x
